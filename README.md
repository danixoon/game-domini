...
- `threshold` - Порог, необходимый у значения свойства игрока. Если игрок обладает данным свойством и его величина превышает порог, эффект применяется. В ином случае, игрок игнорируется.
